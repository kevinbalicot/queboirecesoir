...
class WhenProfilIsEccentricity implements DrinkPredictionRuleInterface
{
    ...
    {
        return $this->isProfileEccentricity->isSatisfiedBy($subject->getProfile());
    }
    ...
    {
        return 'When drinker profil is eccentricity';
    }
}

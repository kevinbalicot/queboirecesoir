...
class WhenProfilIsAltruism implements DrinkPredictionRuleInterface
{
    ...
    {
        return $this->isProfileAltruism->isSatisfiedBy($subject->getProfile());
    }
    ...
    {
        return 'When drinker profil is altruism';
    }
}

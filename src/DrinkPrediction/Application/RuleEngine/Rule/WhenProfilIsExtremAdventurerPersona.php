...
class WhenProfilIsExtremAdventurerPersona implements DrinkPredictionRuleInterface
{
    ...
    {
        return $this->isProfileExtremeAdventurerPersona->isSatisfiedBy($subject->getProfile());
    }

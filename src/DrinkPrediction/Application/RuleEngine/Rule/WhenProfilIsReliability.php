...
class WhenProfilIsReliability implements DrinkPredictionRuleInterface
{
    ...
    {
        return $this->isProfileReliability->isSatisfiedBy($subject->getProfile());
    }
    ...
    {
        return 'When drinker profil is reliability';
    }
}

...
class WhenProfilIsIntuition implements DrinkPredictionRuleInterface
{
    ...
    {
        return $this->isProfileIntuition->isSatisfiedBy($subject->getProfile());
    }
    ...
    {
        return 'When drinker profil is intuition';
    }
}

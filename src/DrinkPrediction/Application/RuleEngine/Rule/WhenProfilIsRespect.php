...
class WhenProfilIsRespect implements DrinkPredictionRuleInterface
{
    ...
    {
        return $this->isProfileRespect->isSatisfiedBy($subject->getProfile());
    }
    ...
    {
        return 'When drinker profil is respect';
    }
}
